...
//                } // Ignore errors
                .then((identifier) => {
                    ...
                    if (eventName == 'Test') {
                        ...
                        const versionTags = payload['properties']['Version'].split('.');
                        console.log('Test:  ' + util.inspect(payload, {showHidden: false, depth: null}));
                        console.log('version:  ' + util.inspect(versionTags, {showHidden: false, depth: null}));
                        if (versionTags[0] >= 10) {
                            console.log('On v10');
                        }
//                        console.log('Test:  ' + util.inspect(payload, {showHidden: false, depth: null}));
