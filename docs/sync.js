...
class User {
     ...
     * @param {string} recipient the optional recipient of the permission.
     ...
     * @param {*} realmUrl - The Realm URL whose permissions settings should be changed. Use * to change 
     * the permissions of all Realms managed by this user.
     * @param {*} accessLevel - The access level to grant matching users. Note that the access level 
     * setting is absolute, i.e. it may revoke permissions for users that previously had a higher access level. 
     * To revoke all permissions, use 'None'
     * @param {*} expiresAt - Optional expiration date of the offer. If set to null, the offer doesn't expire.
     ...
     * @param {*} token - The token, generated by User.offerPermissions
     ...
     * @param {string|PermissionOffer} permissionOfferOrToken - Either the token or the entire PermissionOffer object
     * that was generated with User.offerPermissions. 
     */
