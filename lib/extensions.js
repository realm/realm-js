...
module.exports = function(realmConstructor, environment) {
    ...
    Object.defineProperties(realmConstructor.Set.prototype, require('./set-methods'));
...
Object.defineProperty(realmConstructor.Set.prototype, "toJSON", {
    value: function (_, cache = new Map()) {
        let elementArray = Array.from(this.values());
    ...
    // Object.defineProperty(realmConstructor.Set.prototype, "forEach", {
    //     value: function (_, cache = new Map()) {
    //         let elementArray = Array.from(this.values());
    //         return elementArray.map((item, index) =>
    //             item instanceof realmConstructor.Object ? item.toJSON(index.toString(), cache) : item);
