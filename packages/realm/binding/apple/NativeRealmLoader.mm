...
@interface NativeRealmLoader() <RCTInvalidating>
@end
...
// @interface RealmModule () <RCTBridgeModule, RCTInvalidating, RCTTurboModule>
// @end
...
// + (void) load {
//     NSLog(@"in RealmModule load");
//     facebook::react::registerCxxModuleToGlobalModuleMap([RealmModule.moduleName UTF8String], [&] {
//         NSLog(@"Loading Realm module");
//         return nullptr;
//     });
// }
...
//     printf("Realm getTurboModule(%s)", params.moduleName.c_str());
//     return nullptr;
// }
