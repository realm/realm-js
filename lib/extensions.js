...
module.exports = function(realmConstructor, context) {
    ...
    if (realmConstructor.Sync) {
        ...
        // Object.defineProperty(realmConstructor.User, '_realmConstructor', { value: realmConstructor });
        // realmConstructor.Credentials = {};
        // Object.defineProperties(realmConstructor.Credentials, getOwnPropertyDescriptors(userMethods.credentials));
        ...
        Object.definedProperties(realmConstructor.Credentials, getOwnPropertyDescriptors(credentialMethods.static))
