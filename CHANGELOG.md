...
=============================================================
### Enhancements
* Adds support for setting a custom User-Agent string using `Realm.Sync.setUserAgent(...)`. This string will be sent to the server when creating a connection. ([#2114](https://github.com/realm/realm-js/pull/2114))
