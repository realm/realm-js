...
// let {importApp} = require('./integration-tests/tests/dist/utils/import-app.js')

// appId = "with-db-flx-lctot"
...
realm.write(() => p1 = realm.create("Person", { _id: Realm.BSON.ObjectID(), age: 212, name: "tom2" }))
