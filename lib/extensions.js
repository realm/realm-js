...
module.exports = function(realmConstructor, environment) {
    ...
    realmConstructor.Dictionary = require('./dictionary').Dictionary;
    ...
    setConstructorOnPrototype(realmConstructor.Dictionary);
            ...
            Object.keys(this)
                ...
                .forEach(key => {
                    ...
                    if (value instanceof realmConstructor.Object || value instanceof realmConstructor.Collection) {
                        ...
                        result[key] =  Object.fromEntries(Object.entries(value).map(([k, v]) =>
                            [k, v instanceof realmConstructor.Object ? v.toJSON(k, cache) : v]
                        ));
                    } else {
                        result[key] = value;
                    }
