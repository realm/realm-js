...
inline napi_property_attributes operator|(napi_property_attributes a,
  ...
  napi_property_attributes napi_flag =
      static_cast<napi_property_attributes>(a | flag);
  return napi_flag;
}

template <>
inline Napi::Value node::Object::get_property(Napi::Env env,
...
template <>
inline void node::Object::set_property(Napi::Env env, Napi::Object &object,
                                       const node::String &key,
  ...
  try {
    ...
    if (attributes) {
      ...
      std::string name = key;
      auto propDescriptor =
          Napi::PropertyDescriptor::Value(name, value, napi_attributes);
...
template <>
inline std::vector<node::String>
node::Object::get_property_names(Napi::Env env, const Napi::Object &object) {
  try {
...
template <>
inline Napi::Value node::Object::get_prototype(Napi::Env env,
                                               const Napi::Object &object) {
  napi_value result;
...
template <>
inline void node::Object::set_prototype(Napi::Env env,
                                        const Napi::Object &object,
                                        const Napi::Value &prototype) {
  auto setPrototypeOfFunc = env.Global()
                                .Get("Object")
                                .As<Napi::Object>()
                                .Get("setPrototypeOf")
                                .As<Napi::Function>();
...
template <> inline Napi::Object node::Object::create_empty(Napi::Env env) {
  return Napi::Object::New(env);
}

template <>
inline Napi::Object node::Object::create_array(Napi::Env env, uint32_t length,
                                               const Napi::Value values[]) {
...
inline Napi::Object
node::Object::create_instance(Napi::Env env,
...
inline Napi::Object node::Object::create_instance_by_schema(
  ...
  return node::ObjectWrap<ClassType>::create_instance_by_schema(
      env, constructor, schema, internal);
}

template <>
template <typename ClassType>
inline Napi::Object node::Object::create_instance_by_schema(
    Napi::Env env, const realm::ObjectSchema &schema,
    typename ClassType::Internal *internal) {
  return node::ObjectWrap<ClassType>::create_instance_by_schema(env, schema,
                                                                internal);
}
...
template <>
template <typename ClassType>
inline bool node::Object::is_instance(Napi::Env env,
                                      const Napi::Object &object) {
...
node::Object::get_internal(Napi::Env env, const Napi::Object &object) {
  return node::ObjectWrap<ClassType>::get_internal(env, object);
}

template <>
template <typename ClassType>
inline void node::Object::set_internal(Napi::Env env,
                                       const Napi::Object &object,
                                       typename ClassType::Internal *internal) {
...
template <>
inline void node::Object::set_global(Napi::Env env, const node::String &key,
                                     const Napi::Value &value) {
  Object::set_property(env, env.Global(), key, value);
}

template <>
inline Napi::Value node::Object::get_global(Napi::Env env,
                                            const node::String &key) {
