...
import { ProgressNotificationCallback2 } from "realm/dist/public-types/internal";
...
type UseProgress = number | null;

/**
 *
 * @returns An object containing operations and state for authenticating with an Atlas App.
 */
export function useProgress({ direction, mode }: UserProgressHook): UseProgress {
  ...
  useEffect(() => {
    ...
    const callback: ProgressNotificationCallback2 = (estimate) => {
