...
module.exports = function (realmConstructor) {
  ...
  realmConstructor._defaultOnDiscardCallback = (_, path) => console.log(`ClientReset onDiscard: path = ${path}`);
  realmConstructor._defaultOnRecoveryCallback = (beforeRealm, afterRealm) =>
    console.log(`ClientReset onRecovery: before path = ${beforeRealm.path}, after path = ${afterRealm.path}`);
