...
template <>
inline void realmjsi::Object::set_property(JsiEnv env, JsiObj& object, const realmjsi::String& key,
                                           const JsiVal& value, PropertyAttributes attributes)
{
    if (attributes) {
...
template <>
template <typename ClassType>
inline JsiObj realmjsi::Object::create_instance_by_schema(JsiEnv env, JsiFunc& constructor,
...
template <>
template <typename ClassType>
inline JsiObj realmjsi::Object::create_instance_by_schema(JsiEnv env, const realm::ObjectSchema& schema,
                                                          typename ClassType::Internal* internal)
{
