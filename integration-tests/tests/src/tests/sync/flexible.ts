  ...
  describe("API", function () {
    ...
    for (let i = 0; i < 100; i++) {
      describe("SubscriptionSet class", function () {
        ...
        xdescribe("#removeByName", function () {
        ...
        describe("#removeSubscription", function () {
          xit("returns false if the subscription is not found", function (this: RealmContext) {
            const { subs, sub } = addSubscriptionForPerson(this.realm);
          ...
          xit("returns true and removes the subscription if the subscription is found", function (this: RealmContext) {
            addSubscription(this.realm, this.realm.objects(FlexiblePersonSchema.name).filtered("age > 10"));
            const { subs, sub } = addSubscriptionForPerson(this.realm);
          ...
          xit("if a subscription with the same query is added, the new reference can be removed", function (this: RealmContext) {
            addSubscriptionForPerson(this.realm);
        ...
        describe("#removeAll", function () {
          xit("returns 0 if no subscriptions exist", function (this: RealmContext) {
            const subs = this.realm.subscriptions;
        ...
        xdescribe("#removeByObjectType", function () {
