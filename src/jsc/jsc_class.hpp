...
static inline void jsc_class_init(JSContextRef ctx, JSObjectRef globalObject) {
  ...
  ObjectDefineProperty =
      js::Protected<JSObjectRef>(ctx, Value::to_object(ctx, value));
...
public:
  static JSObjectRef create_instance(JSContextRef ctx,
                                     Internal *internal = nullptr) {
    return JSObjectMake(ctx, get_class(), new ObjectWrap<ClassType>(internal));
  }

  static JSObjectRef
  create_instance_by_schema(JSContextRef ctx, const realm::ObjectSchema &schema,
  ...
  static JSObjectRef
  create_instance_by_schema(JSContextRef ctx, JSObjectRef &constructor,
  ...
  static JSObjectRef create_constructor(JSContextRef ctx) {
    bool isRealmObjectClass =
        std::is_same<ClassType,
                     realm::js::RealmObjectClass<realm::jsc::Types>>::value;
    if (isRealmObjectClass) {
      ...
      JSObjectRef constructor =
          JSObjectMake(ctx, get_constructor_class(ctx), nullptr);
      RealmObjectClassConstructor =
          js::Protected<JSObjectRef>(ctx, constructor);

      JSValueRef value =
          Object::get_property(ctx, RealmObjectClassConstructor, "prototype");
      RealmObjectClassConstructorPrototype =
          js::Protected<JSObjectRef>(ctx, Value::to_object(ctx, value));
...
private:
  ...
  static JSValueRef call(JSContextRef, JSObjectRef, JSObjectRef, size_t,
                         const JSValueRef[], JSValueRef *);
  static JSObjectRef construct(JSContextRef, JSObjectRef, size_t,
                               const JSValueRef[], JSValueRef *);
  static void initialize_constructor(JSContextRef, JSObjectRef);
  static void finalize(JSObjectRef);
  static void get_property_names(JSContextRef, JSObjectRef,
                                 JSPropertyNameAccumulatorRef);
  static JSValueRef get_property(JSContextRef, JSObjectRef, JSStringRef,
                                 JSValueRef *);
  static bool set_property(JSContextRef, JSObjectRef, JSStringRef, JSValueRef,
                           JSValueRef *);

  static bool has_instance(JSContextRef ctx, JSObjectRef constructor,
                           JSValueRef value, JSValueRef *exception);

  static bool set_readonly_property(JSContextRef ctx, JSObjectRef object,
                                    JSStringRef property, JSValueRef value,
                                    JSValueRef *exception) {
    *exception = Exception::value(
        ctx, std::string("Cannot assign to read only property '") +
  ...
  static void define_schema_properties(JSContextRef ctx,
                                       JSObjectRef constructorPrototype,
                                       const realm::ObjectSchema &schema,
                                       bool redefine);
  static void define_accessor_for_schema_property(JSContextRef ctx,
                                                  JSObjectRef &target,
                                                  jsc::String *name);
  static void
  define_native_property_accessor(JSContextRef ctx, JSObjectRef &target,
                                  jsc::String *name,
                                  JSObjectGetPropertyCallback getCallback);
  static JSValueRef
  native_property_getter_callback(JSContextRef ctx, JSObjectRef function,
                                  JSObjectRef thisObject, size_t argumentCount,
                                  const JSValueRef arguments[],
                                  JSValueRef *exception);
  static JSValueRef accessor_getter(JSContextRef ctx, JSObjectRef function,
                                    JSObjectRef this_object, size_t argc,
                                    const JSValueRef arguments[],
                                    JSValueRef *exception);
  static JSValueRef accessor_setter(JSContextRef ctx, JSObjectRef function,
                                    JSObjectRef this_object, size_t argc,
                                    const JSValueRef arguments[],
                                    JSValueRef *exception);
};
...
public:
  ...
  static JSClassRef get_class() { return nullptr; }
};

// The static class variable must be defined as well.
template <typename ClassType> ClassType ObjectWrap<ClassType>::s_class;

template <typename ClassType>
std::unordered_map<std::string,
                   std::unordered_map<std::string, SchemaObjectType *> *>
    ObjectWrap<ClassType>::s_schemaObjectTypes;
...
template <typename ClassType>
inline std::vector<JSStaticFunction>
ObjectWrap<ClassType>::get_methods(const MethodMap &methods) {
  std::vector<JSStaticFunction> functions;
  functions.reserve(methods.size() + 1);

  JSPropertyAttributes attributes = kJSPropertyAttributeReadOnly |
...
template <typename ClassType>
inline std::vector<JSStaticValue>
ObjectWrap<ClassType>::get_properties(const PropertyMap &properties) {
  ...
  for (auto &pair : properties) {
    ...
    values[index++] = {pair.first.c_str(), prop.getter,
                       prop.setter ?: set_readonly_property, attributes};
  }
...
template <typename ClassType>
inline void ObjectWrap<ClassType>::on_context_destroy(JSContextRef ctx,
...
template <typename ClassType>
inline JSValueRef ObjectWrap<ClassType>::accessor_getter(
  ...
  return s_class.string_accessor.getter(ctx, this_object, *propertyName,
                                        exception);
}

template <typename ClassType>
inline JSValueRef ObjectWrap<ClassType>::accessor_setter(
    JSContextRef ctx, JSObjectRef function, JSObjectRef this_object,
    size_t argc, const JSValueRef arguments[], JSValueRef *exception) {
  bool isRealmObjectClass =
      std::is_same<ClassType,
  ...
  bool result = s_class.string_accessor.setter(ctx, this_object, *propertyName,
                                               arguments[0], exception);
  return Value::from_boolean(ctx, result);
}

template <typename ClassType>
inline JSValueRef ObjectWrap<ClassType>::native_property_getter_callback(
  ...
  JSValueRef value = JSObjectGetProperty(
      ctx, function, JSStringCreateWithUTF8CString("propertyName"), &error);
  if (error) {
    *exception = error;
    return nullptr;
  }
  ...
  JSObjectGetPropertyCallback getterCallback =
      (JSObjectGetPropertyCallback)data;
...
template <typename ClassType>
void ObjectWrap<ClassType>::define_accessor_for_schema_property(
    JSContextRef ctx, JSObjectRef &target, jsc::String *name) {
  JSObjectRef descriptor = Object::create_empty(ctx);
  JSValueRef exception = nullptr;

  // create an object with attached function callback. This is to be able to set
  // private data on the function. Use this function as the 'get' function in the
  // property descriptor set the property name as private data. In the future
  // this could be the realm::Property or the table index to speed up the get
  // operation
  JSObjectRef getter = JSObjectMake(ctx, m_getterAccessorClass, name);
  JSObjectSetPrototype(ctx, getter, FunctionPrototype);

  JSObjectSetProperty(ctx, descriptor, JSStringCreateWithUTF8CString("get"),
                      getter, kJSPropertyAttributeReadOnly, &exception);
  if (exception) {
    throw jsc::Exception(ctx, exception);
  }

  JSObjectRef setter = JSObjectMake(ctx, m_setterAccessorClass, name);
  JSObjectSetProperty(ctx, descriptor, JSStringCreateWithUTF8CString("set"),
                      setter, kJSPropertyAttributeReadOnly, &exception);
  if (exception) {
    throw jsc::Exception(ctx, exception);
  }

  JSObjectSetProperty(
      ctx, descriptor, JSStringCreateWithUTF8CString("enumerable"),
      Value::from_boolean(ctx, true), kJSPropertyAttributeReadOnly, &exception);
  if (exception) {
    throw jsc::Exception(ctx, exception);
  }
...
template <typename ClassType>
void ObjectWrap<ClassType>::define_native_property_accessor(
    JSContextRef ctx, JSObjectRef &target, jsc::String *name,
    JSObjectGetPropertyCallback getCallback) {
  ...
  JSObjectRef getter =
      JSObjectMake(ctx, m_NativePropertyGetterClass, (void *)getCallback);
  JSObjectSetPrototype(ctx, getter, FunctionPrototype);
  JSObjectSetProperty(
      ctx, getter, JSStringCreateWithUTF8CString("propertyName"),
      Value::from_string(ctx, *name), kJSPropertyAttributeReadOnly, &exception);
  if (exception) {
    throw jsc::Exception(ctx, exception);
  }
...
static void
define_function_property(JSContextRef ctx, JSObjectRef &target,
                         const char *name,
                         const JSObjectCallAsFunctionCallback &callback) {
  JSObjectRef descriptor = Object::create_empty(ctx);

  JSObjectRef functionValue = JSObjectMakeFunctionWithCallback(
      ctx, JSStringCreateWithUTF8CString(name), callback);

  JSValueRef exception = nullptr;
  JSObjectSetProperty(ctx, descriptor, JSStringCreateWithUTF8CString("value"),
                      functionValue, kJSPropertyAttributeNone, &exception);
  if (exception) {
    throw jsc::Exception(ctx, exception);
  }

  JSObjectSetProperty(
      ctx, descriptor, JSStringCreateWithUTF8CString("writable"),
      Value::from_boolean(ctx, true), kJSPropertyAttributeNone, &exception);
  if (exception) {
    throw jsc::Exception(ctx, exception);
  }

  JSObjectSetProperty(
      ctx, descriptor, JSStringCreateWithUTF8CString("configurable"),
      Value::from_boolean(ctx, true), kJSPropertyAttributeNone, &exception);
  if (exception) {
    throw jsc::Exception(ctx, exception);
  }
...
ObjectWrap<ClassType>::get_internal(JSContextRef ctx,
  ...
  ObjectWrap<ClassType> *realmObjectInstance =
      static_cast<ObjectWrap<ClassType> *>(JSObjectGetPrivate(instance));
  return realmObjectInstance->m_object.get();
}

template <typename ClassType>
void ObjectWrap<ClassType>::set_internal_property(
    JSContextRef ctx, JSObjectRef &instance,
    typename ClassType::Internal *internal) {
  // create a JS object that has a finializer to delete the internal reference
  JSObjectRef internalObject = JSObjectMake(
      ctx, m_internalValueClass, new ObjectWrap<ClassType>(internal));

  const jsc::String *externalName = get_cached_property_name("_external");
  auto attributes = realm::js::PropertyAttributes::ReadOnly |
                    realm::js::PropertyAttributes::DontDelete |
                    realm::js::PropertyAttributes::DontEnum;
  Object::set_property(ctx, instance, *externalName, internalObject,
                       attributes);
}

static inline JSObjectRef try_get_prototype(JSContextRef ctx,
                                            JSObjectRef object) {
  JSValueRef exception = nullptr;
...
// This is called from realm's abstraction layer and by
...
bool ObjectWrap<ClassType>::has_instance(JSContextRef ctx, JSValueRef value) {
  bool isRealmObjectClass =
      std::is_same<ClassType,
                   realm::js::RealmObjectClass<realm::jsc::Types>>::value;
  if (isRealmObjectClass) {
    // Can't use JSValueIsObjectOfClass for RealmObjectClass instances created
    // from a user defined constructor in the schema. Can't use
    // JSValueIsInstanceOfConstructor with the RealmObjectClass constructor since
    // it will recursively call this method again Check if the object has
    // RealmObjectClassConstructorPrototype in its proto chain (the definition of
    // JS 'instanceof')
    ...
    // search for RealmObjectClassConstructor on the prototype chain of the
    // object
    JSObjectRef proto = try_get_prototype(ctx, object);
    while (proto != nullptr && !JSValueIsNull(ctx, proto)) {
      if (JSValueIsStrictEqual(ctx, proto,
                               RealmObjectClassConstructorPrototype)) {
        return true;
      }
    ...
    // handle RealmObjects using user defined ctors without extending
    // RealmObject. In this case we just check for existing internal value to
    // identify RealmObject instances
    auto internal = ObjectWrap<ClassType>::get_internal(ctx, object);
    if (internal != nullptr) {
      return true;
    }

    // if there is no RealmObjectClass on the prototype chain and the object
    // does not have existing internal value then this is not an RealmObject
    // instance
    return false;
  }
...
template <typename ClassType>
bool ObjectWrap<ClassType>::has_instance(JSContextRef ctx,
                                         JSObjectRef constructor,
                                         JSValueRef value,
                                         JSValueRef *exception) {
...
template <typename ClassType>
inline void ObjectWrap<ClassType>::define_schema_properties(
    JSContextRef ctx, JSObjectRef constructorPrototype,
  ...
  for (auto &property : schema.persisted_properties) {
    ...
    if (redefine ||
        !JSObjectHasProperty(ctx, constructorPrototype,
                             JSStringCreateWithUTF8CString(propName.c_str()))) {
...
template <typename ClassType>
inline JSObjectRef ObjectWrap<ClassType>::create_instance_by_schema(
    JSContextRef ctx, JSObjectRef &constructor,
    const realm::ObjectSchema &schema, typename ClassType::Internal *internal) {
  bool isRealmObjectClass =
      std::is_same<ClassType,
                   realm::js::RealmObjectClass<realm::jsc::Types>>::value;
  if (!isRealmObjectClass) {
    JSValueRef exception = jsc::Exception::value(
        ctx,
  ...
  if (isRealmObjectClass && !internal) {
    JSValueRef exception = jsc::Exception::value(
        ctx, "RealmObjectClass requires an internal realm object when creating "
             "instances by schema");
    throw jsc::Exception(ctx, exception);
  }
  ...
  if (constructor == nullptr) {
    if (!schemaObjects->count(schemaName)) {
      ...
      schemaObjectConstructor =
          JSObjectMakeConstructor(ctx, schemaClass, nullptr);
      value = Object::get_property(ctx, schemaObjectConstructor, "prototype");
      constructorPrototype = Value::to_object(ctx, value);

      JSObjectSetPrototype(ctx, constructorPrototype,
                           RealmObjectClassConstructorPrototype);
      JSObjectSetPrototype(ctx, schemaObjectConstructor,
                           RealmObjectClassConstructor);
    ...
    JSValueRef exception = nullptr;
    bool isInstanceOfRealmObjectClass = JSValueIsInstanceOfConstructor(
        ctx, constructorPrototype, RealmObjectClassConstructor, &exception);
    if (exception) {
      throw jsc::Exception(ctx, exception);
    }
    ...
    if (!isInstanceOfRealmObjectClass) {
      ...
      for (auto &pair : s_class.methods) {
        ...
        if (!JSObjectHasProperty(
                ctx, constructorPrototype,
                JSStringCreateWithUTF8CString(pair.first.c_str()))) {
          define_function_property(ctx, constructorPrototype,
      ...
      for (auto &pair : s_class.properties) {
        ...
        if (!JSObjectHasProperty(
          ...
          define_native_property_accessor(ctx, constructorPrototype, name,
                                          getterCallback);
        }
      }
    }
    ...
    // create the instance
    instance = Function::construct(ctx, schemaObjectConstructor, 0, {});
    bool instanceOfSchemaConstructor = JSValueIsInstanceOfConstructor(
        ctx, instance, schemaObjectConstructor, &exception);
    if (exception) {
      throw jsc::Exception(ctx, exception);
    }
    ...
    if (!instanceOfSchemaConstructor) {
      throw jsc::Exception(
          ctx, "Realm object constructor must not return another value");
    }
...
template <typename ClassType>
inline JSValueRef ObjectWrap<ClassType>::call(
    JSContextRef ctx, JSObjectRef function, JSObjectRef this_object,
    size_t argc, const JSValueRef arguments[], JSValueRef *exception) {
  // This should only be called as a super() call in the constructor of a
  // subclass.
  if (!has_instance(ctx, this_object)) {
    *exception = jsc::Exception::value(
        ctx, s_class.name + " cannot be called as a function");
    return nullptr;
  }
...
template <typename ClassType>
inline JSObjectRef
ObjectWrap<ClassType>::construct(JSContextRef ctx, JSObjectRef constructor,
                                 size_t argc, const JSValueRef arguments[],
                                 JSValueRef *exception) {
  if (!reinterpret_cast<void *>(s_class.constructor)) {
    *exception =
        jsc::Exception::value(ctx, s_class.name + " is not a constructor");
    return nullptr;
  }
...
template <typename ClassType>
inline void
ObjectWrap<ClassType>::initialize_constructor(JSContextRef ctx,
                                              JSObjectRef constructor) {
  ...
  Object::set_prototype(
      ...
      Object::get_prototype(
          ctx, JSObjectMakeFunctionWithCallback(ctx, nullptr, call)));

  // Set the constructor prototype to be the prototype generated from the
  // instance JSClassRef.
  JSObjectRef prototype = Object::validated_get_object(
      ctx, JSObjectMakeConstructor(ctx, get_class(), construct),
      prototype_string);
  Object::set_property(ctx, constructor, prototype_string, prototype,
...
inline void ObjectWrap<ClassType>::finalize(JSObjectRef object) {
  ...
  if (auto wrap =
          static_cast<ObjectWrap<ClassType> *>(JSObjectGetPrivate(object))) {
    delete wrap;
...
template <typename ClassType>
inline void ObjectWrap<ClassType>::get_property_names(
...
template <typename ClassType>
inline JSValueRef ObjectWrap<ClassType>::get_property(JSContextRef ctx,
                                                      JSObjectRef object,
...
template <typename ClassType>
inline bool
ObjectWrap<ClassType>::set_property(JSContextRef ctx, JSObjectRef object,
                                    JSStringRef property, JSValueRef value,
                                    JSValueRef *exception) {
  if (JSStringGetLength(property) == 0) {
    return false;
  ...
  if (index_setter || s_class.index_accessor.getter) {
    ...
    if (try_get_int(property, num)) {
      if (num < 0) {
        *exception = Exception::value(
            ctx, util::format("Index %1 cannot be less than zero.", num));
        return false;
      }
      ...
      if (util::int_cast_with_overflow_detect(num, index)) {
        *exception = Exception::value(
            ctx, util::format("Index %1 cannot be greater than %2.", num,
      ...
      *exception = Exception::value(
          ctx, util::format("Cannot assign to read only index %1", index));
      return false;
    }
  }
...
JSValueRef wrap(JSContextRef ctx, JSObjectRef, JSObjectRef this_object,
                size_t argc, const JSValueRef arguments[],
                JSValueRef *exception) {
  jsc::Arguments args{ctx, argc, arguments};
...
JSValueRef wrap(JSContextRef ctx, JSObjectRef object, JSStringRef property,
                JSValueRef *exception) {
  jsc::ReturnValue return_value(ctx);
  try {
...
bool wrap(JSContextRef ctx, JSObjectRef object, JSStringRef property,
          JSValueRef value, JSValueRef *exception) {
  try {
    F(ctx, object, value);
    return true;
...
JSValueRef wrap(JSContextRef ctx, JSObjectRef object, uint32_t index,
                JSValueRef *exception) {
  jsc::ReturnValue return_value(ctx);
  try {
...
bool wrap(JSContextRef ctx, JSObjectRef object, uint32_t index,
          JSValueRef value, JSValueRef *exception) {
  try {
...
void wrap(JSContextRef ctx, JSObjectRef object,
          JSPropertyNameAccumulatorRef accumulator) {
