...
* Downgraded Realm Core to v5.12.1 and Realm Sync to v3.13.4 as a temporary fix due to a regression on Windows. ([#2169](https://github.com/realm/realm-js/issues/2169), since v2.21.0)
