...
const SharedTestSuiteCases: Record<string, TestCase> = {
  dateTests: {
    ...
    tests: [
      ["QueryCount", "DateObject", 2, "dateCol < $0", [2, "dateCol"]],
      ["QueryCount", "DateObject", 3, "dateCol <= $0", [2, "dateCol"]],
      ["QueryCount", "DateObject", 2, "dateCol > $0", [0, "dateCol"]],
      ["QueryCount", "DateObject", 3, "dateCol >= $0", [0, "dateCol"]],
      ["QueryCount", "DateObject", 1, "dateCol == $0", [0, "dateCol"]],
      ["QueryCount", "DateObject", 2, "dateCol != $0", [0, "dateCol"]],
  ...
  boolTests: {
    ...
    tests: [
      ["QueryCount", "BoolObject", 2, "boolCol == true"],
      ["QueryCount", "BoolObject", 1, "boolCol==false"],
      ["QueryCount", "BoolObject", 1, "boolCol != true"],
      ["QueryCount", "BoolObject", 2, "true == boolCol"],
      ["QueryCount", "BoolObject", 2, "boolCol == TRUE"],
      ["QueryCount", "BoolObject", 1, "boolCol == FALSE"],
      ["QueryCount", "BoolObject", 0, "boolCol >  true"],
      ["QueryCount", "BoolObject", 2, "boolCol >= true"],
      ["QueryCount", "BoolObject", 1, "boolCol <  true"],
      ["QueryCount", "BoolObject", 3, "boolCol <= true"],
      ["QueryCount", "BoolObject", 2, "boolCol == $0", true],
      ["QueryCount", "BoolObject", 1, "boolCol == $0", false],
      ["QueryCount", "BoolObject", 0, "boolCol == true && boolCol == false"],
      ["QueryCount", "BoolObject", 3, "boolCol == true || boolCol == false"],
  ...
  intTests: {
    ...
    tests: [
      ["QueryCount", "IntObject", 1, "intCol == -1"],
      ["QueryCount", "IntObject", 1, "intCol==0"],
      ["QueryCount", "IntObject", 0, "1 == intCol"],
      ["QueryCount", "IntObject", 2, "intCol != 0"],
      ["QueryCount", "IntObject", 2, "intCol > -1"],
      ["QueryCount", "IntObject", 3, "intCol >= -1"],
      ["QueryCount", "IntObject", 2, "intCol < 100"],
      ["QueryCount", "IntObject", 3, "intCol <= 100"],
      ["QueryCount", "IntObject", 1, "intCol > 0x1F"],
      ["QueryCount", "IntObject", 1, "intCol == $0", 100],
      ["QueryCount", "IntObject", 2, "intCol >= 0 LIMIT(2)"],
  ...
  floatTests: {
    ...
    tests: [
      ["QueryCount", "FloatObject", 1, "floatCol == -1.001"],
      ["QueryCount", "FloatObject", 1, "floatCol = 0"],
      ["QueryCount", "FloatObject", 0, "floatCol == 1"],
      ["QueryCount", "FloatObject", 2, "floatCol != 0"],
      ["QueryCount", "FloatObject", 2, "floatCol > -1.001"],
      ["QueryCount", "FloatObject", 3, "floatCol >= -1.001"],
      ["QueryCount", "FloatObject", 2, "floatCol < 100.2"],
      ["QueryCount", "FloatObject", 3, "floatCol <= 100.2"],
      ["QueryCount", "FloatObject", 1, "floatCol > 0x1F"],
      ["QueryCount", "FloatObject", 1, "floatCol == $0", 100.2],
      ["QueryCount", "FloatObject", 2, "floatCol >= 0.0"],
  ...
  doubleTests: {
    ...
    tests: [
      ["QueryCount", "DoubleObject", 1, "doubleCol == -1.001"],
      ["QueryCount", "DoubleObject", 1, "doubleCol == 0"],
      ["QueryCount", "DoubleObject", 0, "1 == doubleCol"],
      ["QueryCount", "DoubleObject", 2, "doubleCol != 0"],
      ["QueryCount", "DoubleObject", 2, "doubleCol > -1.001"],
      ["QueryCount", "DoubleObject", 3, "doubleCol >= -1.001"],
      ["QueryCount", "DoubleObject", 2, "doubleCol < 100.2"],
      ["QueryCount", "DoubleObject", 3, "doubleCol <= 100.2"],
      ["QueryCount", "DoubleObject", 1, "doubleCol > 0x1F"],
      ["QueryCount", "DoubleObject", 1, "doubleCol == $0", 100.2],
      ["QueryCount", "DoubleObject", 2, "doubleCol >= 0.0 LIMIT(2)"],
  ...
  stringTests: {
    ...
    tests: [
      ["QueryCount", "StringObject", 2, "stringCol == 'a'"],
      ["QueryCount", "StringObject", 1, "'c' == stringCol"],
      ["QueryCount", "StringObject", 2, 'stringCol == "a"'],
      ["QueryCount", "StringObject", 1, "stringCol=='abc'"],
      ["QueryCount", "StringObject", 1, "stringCol == ''"],
      ["QueryCount", "StringObject", 8, "stringCol != ''"],
      ["QueryCount", "StringObject", 1, 'stringCol == "\\"\\n\\0\\r\\\\\'"'],
      ["QueryCount", "StringObject", 3, "stringCol BEGINSWITH 'a'"],
      ["QueryCount", "StringObject", 1, "stringCol beginswith 'ab'"],
      ["QueryCount", "StringObject", 0, "stringCol BEGINSWITH 'abcd'"],
      ["QueryCount", "StringObject", 2, "stringCol BEGINSWITH 'A'"],
      ["QueryCount", "StringObject", 2, "stringCol ENDSWITH 'c'"],
      ["QueryCount", "StringObject", 1, "stringCol endswith 'bc'"],
      ["QueryCount", "StringObject", 9, "stringCol ENDSWITH ''"],
      ["QueryCount", "StringObject", 1, "stringCol CONTAINS 'b'"],
      ["QueryCount", "StringObject", 2, "stringCol contains 'c'"],
      ["QueryCount", "StringObject", 9, "stringCol CONTAINS ''"],
      ["QueryCount", "StringObject", 2, "stringCol == $0", "a"],
      ["QueryCount", "StringObject", 2, "stringCol ENDSWITH $0", "c"],
      ["QueryCount", "StringObject", 2, "stringCol BEGINSWITH 'a' LIMIT(2)"],
      ...
      ["QueryCount", "StringObject", 3, "stringCol ==[c] 'a'"],
      ["QueryCount", "StringObject", 5, "stringCol BEGINSWITH[c] 'A'"],
      ["QueryCount", "StringObject", 4, "stringCol ENDSWITH[c] 'c'"],
      ["QueryCount", "StringObject", 2, "stringCol CONTAINS[c] 'B'"],
    ],
  },
  ...
  binaryTests: {
    ...
    tests: [
      ["QueryCount", "BinaryObject", 1, "binaryCol == $0", [1, "binaryCol"]],
      ["QueryCount", "BinaryObject", 1, "$0 == binaryCol", [2, "binaryCol"]],
      ["QueryCount", "BinaryObject", 4, "binaryCol != $0", [0, "binaryCol"]],
      ["QueryCount", "BinaryObject", 1, "binaryCol BEGINSWITH $0", [0, "binaryCol"]],
      ["QueryCount", "BinaryObject", 2, "binaryCol BEGINSWITH $0", [1, "binaryCol"]],
      ["QueryCount", "BinaryObject", 2, "binaryCol ENDSWITH $0", [4, "binaryCol"]],
      ["QueryCount", "BinaryObject", 3, "binaryCol CONTAINS $0", [2, "binaryCol"]],
    ],
  },
  ...
  objectTests: {
    ...
    tests: [
      ["QueryCount", "LinkObject", 1, "linkCol == $0", [1, "linkCol"]],
      ["QueryCount", "LinkObject", 1, "$0 == linkCol", [1, "linkCol"]],
      ["QueryCount", "LinkObject", 2, "linkCol != $0", [0, "linkCol"]],
      ["QueryCount", "LinkObject", 1, "linkCol = null"],
      ["QueryCount", "LinkObject", 2, "linkCol != NULL"],
      ["QueryCount", "LinkObject", 1, "linkCol = $0", null],
  ...
  compoundTests: {
    ...
    tests: [
      ...
      ["ObjectSet", "IntObject", [0, 1], "intCol == 0 || intCol == 1"],
      ["ObjectSet", "IntObject", [0], "intCol == 0 && intCol != 1"],
      ["ObjectSet", "IntObject", [2, 3], "intCol >= 2 && intCol < 4"],
      ["ObjectSet", "IntObject", [0], "intCol == 0 && NOT intCol != 0"],
      ["ObjectSet", "IntObject", [0, 3], "intCol == 0 || NOT (intCol == 1 || intCol == 2)"],
      ["ObjectSet", "IntObject", [1], "(intCol == 0 || intCol == 1) && intCol >= 1"],
      ["ObjectSet", "IntObject", [1], "intCol >= 1 && (intCol == 0 || intCol == 1)"],
      ["ObjectSet", "IntObject", [0, 1], "intCol == 0 || (intCol == 1 && intCol >= 1)"],
      ["ObjectSet", "IntObject", [0, 1], "(intCol == 1 && intCol >= 1) || intCol == 0"],
      ["ObjectSet", "IntObject", [0, 1], "intCol == 0 || intCol == 1 && intCol >= 1"],
      ["ObjectSet", "IntObject", [0, 1, 2], "intCol == 0 || intCol == 1 || intCol <= 2"],
      ["ObjectSet", "IntObject", [0, 1], "intCol == 1 && intCol >= 1 || intCol == 0"],
      ["ObjectSet", "IntObject", [0, 1], "intCol == 1 || intCol == 0 && intCol <= 0 && intCol >= 0"],
      ["ObjectSet", "IntObject", [0, 1], "intCol == 0 || NOT (intCol == 3 && intCol >= 0) && intCol == 1"],
    ],
  },
  ...
  keyPathTests: {
    ...
    tests: [
      ["ObjectSet", "LinkTypesObject", [0, 2], "basicLink.intCol == 1"],
      ["ObjectSet", "LinkTypesObject", [1], "linkLink.basicLink.intCol == 1"],
      ["ObjectSet", "LinkTypesObject", [1, 3], "linkLink.basicLink.intCol > 0"],
      ["ObjectSet", "LinkTypesObject", [0, 2], "basicLink.floatCol == 0.1"],
      ["ObjectSet", "LinkTypesObject", [1], "linkLink.basicLink.floatCol == 0.1"],
      ["ObjectSet", "LinkTypesObject", [1, 3], "linkLink.basicLink.floatCol > 0"],
      ["ObjectSet", "LinkTypesObject", [5], "linkList.intCol == 3"],
    ],
  },
  ...
  optionalTests: {
    ...
    tests: [
      ["ObjectSet", "OptionalTypesObject", [1], "intCol == null"],
      ["ObjectSet", "OptionalTypesObject", [1], "null == intCol"],
      ["ObjectSet", "OptionalTypesObject", [0], "intCol != null"],
      ["ObjectSet", "OptionalTypesObject", [1], "floatCol == null"],
      ["ObjectSet", "OptionalTypesObject", [0], "floatCol != null"],
      ["ObjectSet", "OptionalTypesObject", [1], "doubleCol == null"],
      ["ObjectSet", "OptionalTypesObject", [0], "doubleCol != null"],
      ["ObjectSet", "OptionalTypesObject", [1], "stringCol == null"],
      ["ObjectSet", "OptionalTypesObject", [0], "stringCol != null"],
      ["ObjectSet", "OptionalTypesObject", [1], "dateCol == null"],
      ["ObjectSet", "OptionalTypesObject", [0], "dateCol != null"],
      ["ObjectSet", "OptionalTypesObject", [1], "dataCol == null"],
      ["ObjectSet", "OptionalTypesObject", [0], "dataCol != null"],

      ["ObjectSet", "LinkTypesObject", [1], "basicLink.intCol == null"],
      ["ObjectSet", "LinkTypesObject", [0], "basicLink.intCol != null"],
      ["ObjectSet", "LinkTypesObject", [1], "basicLink.floatCol == null"],
      ["ObjectSet", "LinkTypesObject", [0], "basicLink.floatCol != null"],
      ["ObjectSet", "LinkTypesObject", [1], "basicLink.doubleCol == null"],
      ["ObjectSet", "LinkTypesObject", [0], "basicLink.doubleCol != null"],
      ["ObjectSet", "LinkTypesObject", [1], "basicLink.stringCol == null"],
      ["ObjectSet", "LinkTypesObject", [0], "basicLink.stringCol != null"],
      ["ObjectSet", "LinkTypesObject", [1], "basicLink.dateCol == null"],
      ["ObjectSet", "LinkTypesObject", [0], "basicLink.dateCol != null"],
    ],
  },
  ...
  orderingTests: {
    ...
    tests: [
      ["ObjectSet", "Person", [1, 3], "age > 20 SORT(age DESC) DISTINCT(name)"],
      ["ObjectSet", "Person", [2, 0], "age > 20 SORT(age ASC) DISTINCT(name)"],
      ["ObjectSet", "Person", [2, 0], "age > 20 SORT(age ASC, name DESC) DISTINCT(name)"],
      ["ObjectSet", "Person", [2, 0], "age > 20 SORT(name DESC) SORT(age ASC) DISTINCT(name)"],
      ["ObjectSet", "Person", [2, 0, 3, 1], "age > 20 SORT(age ASC, name DESC) DISTINCT(name, age)"],
      ["ObjectSet", "Person", [0, 2], "age > 20 SORT(age ASC) DISTINCT(age) SORT(name DESC) DISTINCT(name)"],
    ],
  },
  ...
  primitiveListTests: {
    ...
    tests: [
      ["ObjectSet", "Movie", [0, 1, 2], "tags =[c] 'science fiction'"],
      ["ObjectSet", "Movie", [0, 1, 2], "tags BEGINSWITH[c] 'science'"],
      ["ObjectSet", "Movie", [], "NONE tags CONTAINS ' '"],
      ["ObjectSet", "Movie", [0, 1], "ratings.@avg >= 4"],
      ["ObjectSet", "Movie", [1], "ALL ratings > 1"],
      ["ObjectSet", "Movie", [], "ANY tags CONTAINS[c] name"],
      ["ObjectSet", "Movie", [1, 2], "tags.@size > 2"],
      ["ObjectSet", "Movie", [0], "tags.length > 16"],
      ["ObjectSet", "Movie", [0], "ALL tags.length > 5"],
      ["ObjectSet", "Movie", [0, 1], "ratings.@min > id"],
      ["ObjectSet", "Movie", [0, 1, 2], "ratings.@count > 0"],
    ],
  },
  ...
  objectIdTests: {
    ...
    tests: [
      ["QueryCount", "ObjectIdObject", 1, "id == $0", [3, "id"]],
      ["QueryCount", "ObjectIdObject", 1, "$0 == id", [3, "id"]],
      ["QueryCount", "ObjectIdObject", 4, "id != $0", [2, "id"]],

      ["QueryCount", "ObjectIdObject", 1, "id == oid(6001c033600510df3bbfd864)"],
      ["QueryCount", "ObjectIdObject", 1, "oid(6001c04b3bc6feeda9ef44f3) == id"],
      ["QueryCount", "ObjectIdObject", 4, "id != oid(6001c033600510df3bbfd864)"],
    ],
  },
  ...
  objectIdOptionalTests: {
    ...
    tests: [
      ["QueryCount", "ObjectIdObject", 2, "id == $0", null],
      ["QueryCount", "ObjectIdObject", 2, "$0 == id", null],
      ["QueryCount", "ObjectIdObject", 3, "id != $0", null],

      ["QueryCount", "ObjectIdObject", 2, "id == null"],
      ["QueryCount", "ObjectIdObject", 2, "null == id"],
      ["QueryCount", "ObjectIdObject", 3, "id != null"],
    ],
  },
  ...
  uuidTests: {
    ...
    tests: [
      ["QueryCount", "UUIDObject", 1, "id == $0", [3, "id"]],
      ["QueryCount", "UUIDObject", 1, "$0 == id", [3, "id"]],
      ["QueryCount", "UUIDObject", 4, "id != $0", [2, "id"]],

      ["QueryCount", "UUIDObject", 1, "id == uuid(d1b186e1-e9e0-4768-a1a7-c492519d47ee)"],
      ["QueryCount", "UUIDObject", 1, "uuid(08c35c66-69bd-4b28-8177-f9135553711f) == id"],
      ["QueryCount", "UUIDObject", 4, "id != uuid(d1b186e1-e9e0-4768-a1a7-c492519d47ee)"],
    ],
  },
  ...
  uuidOptionalTests: {
    ...
    tests: [
      ["QueryCount", "UUIDObject", 2, "id == $0", null],
      ["QueryCount", "UUIDObject", 2, "$0 == id", null],
      ["QueryCount", "UUIDObject", 3, "id != $0", null],

      ["QueryCount", "UUIDObject", 2, "id == null"],
      ["QueryCount", "UUIDObject", 2, "null == id"],
      ["QueryCount", "UUIDObject", 3, "id != null"],
    ],
  },
};
