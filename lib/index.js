...
const realmModule = NativeModules.Realm
const realmEmitter = new NativeEventEmitter(realmModule)
const subscription = realmEmitter.addListener('DummyEvent', function(){});
