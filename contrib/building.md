...
5. Change to the Realm JS root and copy the header to the other location where it is needed with `cp src/android/io_realm_react_RealmReactModule.cpp react-native/android/`
