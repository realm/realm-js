...
* Clearing a nested collection may end with a crash. ([realm/realm-core#7556](https://github.com/realm/realm-core/issues/7556), since v12.7.0-rc.0)
* Removing nested collections in `mixed` for synced Realms throws an exception. ([realm/realm-core#7573](https://github.com/realm/realm-core/issues/7573), since v12.7.0.rc.0)
...
* Upgraded Realm Core from v13.26.0 to v14.5.1. ([#6499](https://github.com/realm/realm-js/issues/6499), [#6541](https://github.com/realm/realm-js/issues/6541), [#6568](https://github.com/realm/realm-js/issues/6568), [#6572](https://github.com/realm/realm-js/issues/6572), [#6599](https://github.com/realm/realm-js/issues/6599), and [#6611](https://github.com/realm/realm-js/issues/6610))
