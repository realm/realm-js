...
export class App {
  ...
  public removeUser(user: User): unknown {
    return this.internal.removeUser(user.internal);
  }

  public deleteUser(user: User): unknown {
    return this.internal.deleteUser(user.internal);
  }
