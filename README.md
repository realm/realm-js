...
This project hosts the JavaScript versions of [Realm](https://docs.mongodb.com/realm/). Currently we only support React Native (both iOS & Android) and Node.js (on Windows, MacOS and Linux).
