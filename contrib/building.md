...
Moreover, in order to avoid introducting false positives in our analytics dataset, it is highly recommended to disable analytics by add the following to your shell configuration:
