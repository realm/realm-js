...
template <>
inline bool realmjsi::Value::is_array_buffer_view(JsiEnv env,
                                                const JsiVal &value) {
...
template <> inline JsiVal realmjsi::Value::from_null(JsiEnv env) {
  return env.null();
}
...
template <>
inline JsiVal realmjsi::Value::from_nonnull_string(JsiEnv env,
                                                 const realmjsi::String &string) {
  return str(env, StringData(string));
}

template <>
inline JsiVal realmjsi::Value::from_nonnull_binary(JsiEnv env, BinaryData data) {
  fbjsi::ArrayBuffer buffer = globalType(env, "ArrayBuffer")
...
template <> inline JsiVal realmjsi::Value::from_undefined(JsiEnv env) {
...
template <>
inline realmjsi::String realmjsi::Value::to_string(JsiEnv env,
                                               const JsiVal &value) {
...
template <>
inline OwnedBinaryData realmjsi::Value::to_binary(JsiEnv env,
                                                const JsiVal &value) {
...
template <>
inline JsiVal realmjsi::Value::from_decimal128(JsiEnv env,
...
template <>
inline Decimal128 realmjsi::Value::to_decimal128(JsiEnv env,
                                               const JsiVal &value) {
  return Decimal128(value->toString(env).utf8(env));
}

template <>
inline JsiVal realmjsi::Value::from_object_id(JsiEnv env,
