      ...
      if (environment === "reactnative") {
        ...
        if (Platform.OS === "ios") {
          if (Platform.isPad()) {
            ...
            deviceName = "AppleTV";
          } else { // RN doesn't support Apple Watch
            deviceName = "iPhone";
          }
        ...
        return {
          ...
          cpuArch: "unknown", // TODO: how to detect CPU architecture on Android and iOS? Do we need seperate methods in platform.{mm, cpp)
