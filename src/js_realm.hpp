...
inline typename T::Function RealmClass<T>::create_constructor(ContextType ctx) {
    ...
    FunctionType set_type_constructor = ObjectWrap<T, SetClass<T>>::create_constructor(ctx);
    ...
    Object::set_property(ctx, realm_constructor, "Set", set_type_constructor, attributes);
