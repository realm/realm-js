...
module.exports = function(realmConstructor) {
    ...
    if (realmConstructor.Sync) {
        ...
        realmConstructor.Sync.ClientResetError = require('./errors').ClientResetError;
        ...
        realmConstructor.Sync.ClientResetError.initiate = function(path) {
            realmConstructor.Sync._initiateClientReset(path);
        }
    }
