...
describe('Notifier', () => {
    ...
    it("should be able to change the listener directory", async function() {
        ...
        expect(fs.existsSync(`${temp.name}/realms${realmFile.path}/${realmFile.objectId()}.realm`)).toBeTruthy();
        temp.removeCallback();
    });
    ...
    xit('should remove the local Realm file after the notification completes', async() => {
        ...
        const path = `${root}/realms${realmFile.path}/${realmFile.objectId()}.realm`;
