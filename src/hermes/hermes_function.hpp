...
template <>
inline JsiVal hermes::Function::call(JsiEnv env, const JsiFunc& function, const JsiObj& this_object, size_t argc,
...
template <>
inline JsiVal hermes::Function::callback(JsiEnv env, const JsiFunc& function, const JsiObj& this_object, size_t argc,
                                         const JsiVal arguments[])
{
    return env(function->callWithThis(env, this_object, env.args(arguments, argc), argc));
}
