...
const instanceMethods = {
    logout() {
        ...
        createConfiguration(config) {
            ...
            // During the deprecation period we only set `fullSynchronization` if partial has not been set
            ...
            return (config === undefined) ? defaultConfig : merge(defaultConfig, config);
        },
    };
