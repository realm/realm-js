...
template <>
inline JSValueRef jsc::Object::get_property(JSContextRef ctx,
                                            const JSObjectRef &object,
                                            const jsc::String &key) {
...
template <>
inline void jsc::Object::set_property(JSContextRef ctx, JSObjectRef &object,
                                      const jsc::String &key,
...
template <>
inline void jsc::Object::set_property(JSContextRef ctx, JSObjectRef &object,
                                      uint32_t index, const JSValueRef &value) {
  JSValueRef exception = nullptr;
...
template <>
inline std::vector<jsc::String>
jsc::Object::get_property_names(JSContextRef ctx, const JSObjectRef &object) {
  JSPropertyNameArrayRef property_names =
...
template <>
inline JSValueRef jsc::Object::get_prototype(JSContextRef ctx,
                                             const JSObjectRef &object) {
  return JSObjectGetPrototype(ctx, object);
}

template <>
inline void jsc::Object::set_prototype(JSContextRef ctx,
                                       const JSObjectRef &object,
                                       const JSValueRef &prototype) {
  JSObjectSetPrototype(ctx, object, prototype);
}

template <> inline JSObjectRef jsc::Object::create_empty(JSContextRef ctx) {
  return JSObjectMake(ctx, nullptr, nullptr);
}

template <>
inline JSObjectRef jsc::Object::create_array(JSContextRef ctx, uint32_t length,
...
inline JSObjectRef
jsc::Object::create_instance(JSContextRef ctx,
...
inline JSObjectRef jsc::Object::create_instance_by_schema(
  ...
  return jsc::ObjectWrap<ClassType>::create_instance_by_schema(
...
template <typename ClassType>
inline JSObjectRef
jsc::Object::create_instance_by_schema(JSContextRef ctx,
                                       const realm::ObjectSchema &schema,
                                       typename ClassType::Internal *internal) {
  return jsc::ObjectWrap<ClassType>::create_instance_by_schema(ctx, schema,
                                                               internal);
}
...
template <>
template <typename ClassType>
inline bool jsc::Object::is_instance(JSContextRef ctx,
                                     const JSObjectRef &object) {
...
jsc::Object::get_internal(JSContextRef ctx, const JSObjectRef &object) {
  return jsc::ObjectWrap<ClassType>::get_internal(ctx, object);
}

template <>
template <typename ClassType>
inline void jsc::Object::set_internal(JSContextRef ctx,
                                      const JSObjectRef &object,
                                      typename ClassType::Internal *ptr) {
  auto wrap =
      static_cast<jsc::ObjectWrap<ClassType> *>(JSObjectGetPrivate(object));
  *wrap = ptr;
}

template <>
inline void jsc::Object::set_global(JSContextRef ctx, const jsc::String &key,
                                    const JSValueRef &value) {
  JSObjectRef global_object = JSContextGetGlobalObject(ctx);
  jsc::Object::set_property(ctx, global_object, key, value,
                            js::ReadOnly | js::DontEnum | js::DontDelete);
}

template <>
inline JSValueRef jsc::Object::get_global(JSContextRef ctx,
                                          const jsc::String &key) {
  JSObjectRef global_object = JSContextGetGlobalObject(ctx);
