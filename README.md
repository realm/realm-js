...
This project hosts the JavaScript versions of [Realm](https://realm.io/). Currently, we support React Native (both iOS & Android) and Node.js (on MacOS, Linux, and Windows).
