...
export class EmailPasswordAuthClient {
     ...
     * @since v10.10.0
     */
    async resendConfirmationEmail(detail) {
     ...
     * @since v10.10.0
     */
    async sendResetPasswordEmail(credential) {
        await this.internal.sendResetPasswordEmail(credential.email);
    }
    async callResetPasswordFunction(credentials, ...args) {
        await this.internal.callResetPasswordFunction(credentials.email, credentials.password, args);
    }
}
//# sourceMappingURL=EmailPasswordAuthClient.js.map