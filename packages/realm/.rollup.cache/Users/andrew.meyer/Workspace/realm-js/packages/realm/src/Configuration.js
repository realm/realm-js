...
//
////////////////////////////////////////////////////////////////////////////
import { RealmObject, assert, } from "./internal";
...
// };
export function validateConfiguration(arg) {
    assert.object(arg);
...
export function validateRealmSchema(schema) {
...
export function validateObjectSchema(arg) {
